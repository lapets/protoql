  ...
  */
  ...
  protoql.Geometry = (function(Visualization) {
    ...
    */
    ...
    Geometry.orthogonal = (function(v, w) { return {x:v.x-w.y, y:v.y+w.x}; });
    Geometry.normalize =
      (function(v) {
        ...
        Visualization.linksEnter
          .attr("d", function (e) {
            ...
            if (Visualization.geometry.inShape(t, e.source) || Visualization.geometry.inShape(s, e.target)) {
              ...
              var mid = Visualization.geometry.middle(s, t);
              var orth = Visualization.geometry.orthogonal(s, t);
              var offset = Visualization.geometry.sum(mid, orth);
              var p = Visualization.geometry.normalize(mid);
              return lineFunction([s, p, t]);
            } else {
