    ...
    var tick =
      (function(e) {
        ...
        V.linksEnter
          ...
          .each(function(e) {
            //G.scale(V.zoompan.scale, V.zoompan.translate);
            var t = V.zoompan.translate, s = V.zoompan.scale,
                o = G.sum(G.offpath(G.scale(s, e.source), G.scale(s, e.target), 15*s), t);
      ...
      (function(value) {
        ...
        if (V.interaction.zoom)
          ...
          .on("dblclick.zoom", function() {
              if (V.txt != null)
                V.build(V.txt.value);
              V.vis.transition().duration(300).attr('transform', 'translate(0,0) scale(1)');
