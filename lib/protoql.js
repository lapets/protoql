        ...
        Visualization.linksEnter
          .attr("d", function (e) {
            ...
            if (G.inShape(t, e.source) || G.inShape(s, e.target)) {
              ...
              var d = G.diff(t, s), m = G.middle(s, t),
                  o = G.rotate(G.normalize(d)), n = G.scale(16, o), off = G.scale(5, o),
                  s = G.onEdge(e, 'source', off), t = G.onEdge(e, 'target', off);
              return lineFunction([s, G.sum(m, n), t]);
            } else {
